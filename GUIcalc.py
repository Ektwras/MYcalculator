...
label_result = Label(root, width=25, height=2, text="",  bd=1, fg="#fe9037", bg="#333333", font=("arial", 30, "bold"))
label_result.pack()
label_result.place(x=0,y=10)
...
Button(root, text="x", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#3697f5",
...
Button(root, text="-", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#3697f5",
...
Button(root, text="0", width=11, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#3697f5",
